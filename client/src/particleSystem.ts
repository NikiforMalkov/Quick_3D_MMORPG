...
import { Box3, BufferGeometry, Color, Float32BufferAttribute, Points, ShaderMaterial, Sphere, TextureLoader, Vector3 } from 'three';
...
export interface LerpInterface {
  (t:number, a:any, b:number): number;
}
...
class LinearSpline {
  ...
  constructor(lerp:LerpInterface) {
    this._lerp = lerp
  }

  AddPoint(t:number, d:number|Color) {
...
export class ParticleSystem {
  ...
  material_ : ShaderMaterial = new ShaderMaterial({    })
  geometry_ = new BufferGeometry()
  emitters_: Array<ParticleEmitter> = [];
  particles_: Array<any> = [];
  camera_:any;
  points_:Points;
  ...
  constructor(params:any) {
    ...
    this.geometry_.setAttribute('position', new Float32BufferAttribute([], 3))
    this.geometry_.setAttribute('size', new Float32BufferAttribute([], 1))
    this.geometry_.setAttribute('colour', new Float32BufferAttribute([], 4))
    this.geometry_.setAttribute('angle', new Float32BufferAttribute([], 1))
    this.geometry_.setAttribute('blend', new Float32BufferAttribute([], 1))

    this.points_ = new Points(this.geometry_, this.material_)
  ...
  UpdateGeometry_() {
    ...
    this.geometry_.setAttribute('size', new Float32BufferAttribute(sizes, 1))
    this.geometry_.setAttribute('colour', new Float32BufferAttribute(colours, 4))
    this.geometry_.setAttribute('angle', new Float32BufferAttribute(angles, 1))
    this.geometry_.setAttribute('blend', new Float32BufferAttribute(blends, 1))
    ...
    this.geometry_.boundingSphere = new Sphere()
