...
export class BloodEffect extends Component {
  ...
  InitComponent() {
    this._RegisterHandler('events.network', (m:any) => {
      this.OnEvents_(m)
    })
  ...
  EmitFireFX_() {
    ...
    for (let t of targets) {
      ...
      emitter.colourSpline_.AddPoint(0.0, new Color(0x00ff00))
      emitter.colourSpline_.AddPoint(0.3, new Color(0x00ff00))
      emitter.colourSpline_.AddPoint(0.4, new Color(0xdeec42))
      emitter.colourSpline_.AddPoint(1.0, new Color(0xf4a776))
      ...
      emitter.colourSpline_.AddPoint(0.0, new Color(0x000000))
      emitter.colourSpline_.AddPoint(1.0, new Color(0x000000))
  ...
  EmitBloodFX_() {
    ...
    for (let t of targets) {
      ...
      emitter.colourSpline_.AddPoint(0.0, new Color(0xbb2909))
      emitter.colourSpline_.AddPoint(1.0, new Color(0x701a08))
