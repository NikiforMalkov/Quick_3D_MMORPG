...
export class SorcerorEffect extends Component {
  ...
  InitComponent() {
    this._RegisterHandler('action.attack', (m:any) => {
      this.OnAttack_(m)
    })
  ...
  OnAttack_(_:any) {
    ...
    for (let h of hands) {
      ...
      emitter.colourSpline_.AddPoint(0.5, new Color(0x40c040))
      emitter.colourSpline_.AddPoint(1.0, new Color(0xff4040))
      ...
      emitter.colourSpline_.AddPoint(0.0, new Color(0x202020))
      emitter.colourSpline_.AddPoint(1.0, new Color(0x101010))
