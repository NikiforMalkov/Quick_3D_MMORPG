...
export class ThreeJSController extends Component {
  ...
  //TODO: types
  threejs_:WebGLRenderer = new WebGLRenderer({
    antialias: false
  })
  camera_:PerspectiveCamera = new PerspectiveCamera()
  scene_:Scene = new Scene()
  sun_:DirectionalLight = new DirectionalLight();
  _OnWindowResize:any;
  ...
  InitEntity() {
    ...
    //TODO: подумать над этим, устарело
    ...
    this.scene_.fog = new FogExp2(0x89b2eb, 0.00002)

    let light = new DirectionalLight(0x8088b3, 0.7)
  ...
  Update(_:number) {
    ...
    this.sun_.position.add(new Vector3(-50, 200, -10))
