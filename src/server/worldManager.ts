import { CHARACTER_MODELS } from './../client/shared/defs';
import { HeightGenerator } from './../client/shared/terrainHeight';
import { SpatialHashGrid } from './../client/shared/spatialHashGrid';
import { quat, vec3 } from "gl-matrix";
import { SocketWrapperInterface, WorldServerInterface } from './worldServer';
import { WorldEntity } from './worldEntity';
import { WorldAIClient, WorldClientInteface, WorldNetworkClient } from './worldClient';
...
class MonsterSpawner {
    ...
    entity_: WorldClientInteface | null = null;
...
export interface WorldManagerInterface {
    ...
    AddMonster(e:WorldClientInteface): void
...
export class WorldManager implements WorldManagerInterface {
    ...
    AddMonster(e:WorldClientInteface) {
    ...
    UpdateEntities_(timeElapsed:number) {
        const dead:WorldClientInteface[] = [];
        const alive:WorldClientInteface[] = [];
