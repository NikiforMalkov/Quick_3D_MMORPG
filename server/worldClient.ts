...
import { DescriptionInterface, StatsInterface, WorldEntityInterface } from "../shared/worldEntityInterface";
...
interface ChatMessageInterface {
  ...
  export interface WorldClientInterface {
  ...
  class WorldClient implements WorldClientInterface {
  ...
  export class WorldNetworkClient extends WorldClient {
    ...
    OnUpdateClientState_() {
      const _Filter = (e:WorldEntityInterface) => {
...
class AIState_JustSitThere extends AIState {
  ...
  timer_;
  entity_:WorldEntityInterface | null = null;
  parent_:any;

  constructor(target?:WorldEntityInterface | null) {
    super();
...
class AIState_FollowToAttack extends AIState {
  ...
  target_: WorldEntityInterface | null = null;
  entity_: WorldEntityInterface | null = null;
  terrain_:HeightGenerator | null = null;
  parent_:any;

  constructor(target: WorldEntityInterface | undefined | null = null) {
    super();
    this.target_ = target;
  }
